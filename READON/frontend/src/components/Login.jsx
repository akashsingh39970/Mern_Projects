...
const submitEventHandler = (event) => {
  ...
  setShowUserLogin(false);
    ...
    return (
        ...
        className="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center bg-black/60 z-30 text-sm 
        text-gray-600">
             <form onClick={(e)=>e.stopPropagation()} className="flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg 
            ...
            className="bg-primary hover:bg-primary-dull transition-all text-white w-full py-2 
